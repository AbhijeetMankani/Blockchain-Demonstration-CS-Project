...
CREATE TABLE IF NOT EXISTS All_Transactions( Transaction_ID INT PRIMARY KEY, Sender_ID CHAR(64) NOT NULL, Reciever_ID CHAR(64) NOT NULL, Amount FLOAT NOT NULL, Mined BOOLEAN NOT NULL, trans JSON NOT NULL, trans_sign CHAR(128) NOT NULL );
